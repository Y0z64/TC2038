...
/**
 * Función merge
 * Complejidad Temporal: O(n), donde n es el número total de elementos en ambos
 * vectores de entrada. Esta función siempre compara y fusiona todos los
 * elementos de ambos vectores de entrada.
 *
 * Análisis:
 ...
 *
 * Complejidad Espacial: O(n), donde n es la suma de los tamaños de leftArr y
 * rightArr
 */
 ...
 * Peor Caso: O(n log n) - cuando el vector está en orden inverso o desordenado
 * aleatoriamente
 *
 * Complejidad Espacial: O(n) debido al espacio auxiliar utilizado en el paso de
 * fusión
 */
void mergeSort(std::vector<double> &arr, int left, int right) {
  ...
  // 1. y 2. Dividr el arreglo mediante indices y ordenar recursivamente los
  // subvectores
